...
def warp_corners_and_draw_matches(ref_points, dst_points, img1, img2):
    ...
    cv2.imwrite("check.png", img_matches)
...
if __name__ == "__main__":
    ...
    ''' 
        主要如下4个输入参数:
    '''
    imgPath = "/mnt/c/Users/Asher/Desktop/Data/relative_frames/7d870e3c8bb3c48acab2c965"
    img1file = os.path.join(imgPath, "XAG965_0031.JPG")
    img2file = os.path.join(imgPath, "XAG965_0032.JPG")
    img3file = os.path.join(imgPath, "XAG965_0050.JPG")
    ...
    mkpts_11, mkpts_2 = xfeat.match_lighterglue(output1, output2)

    warp_corners_and_draw_matches(mkpts_11, mkpts_2, im2, im3)
    ...
    # F12, mask12 = cv2.findHomography(mkpts_0, mkpts_1, cv2.FM_RANSAC, 3, 0.999, maxIters=1000)
    # mask12 = mask12.flatten()

    # F23, mask23 = cv2.findHomography(mkpts_11, mkpts_2, cv2.FM_RANSAC, 3, 0.999, maxIters=1000)
    # mask23 = mask23.flatten()
